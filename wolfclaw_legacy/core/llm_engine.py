...
class WolfEngine:
    ...
    Now with multi-model fallback, memory injection, and autonomous reflection.
    """

    def __init__(self, model_name: str, fallback_models: list = None):
        """
        Initializes the engine with a primary model and optional fallbacks.
        Examples: 'ollama/llama3', 'nvidia/llama-3.1-70b-instruct', 'gpt-4o'
        """
    ...
    def chat(self, messages: list, system_prompt: str = None, stream: bool = False, bot_id: str = None):
        ...
        if global_soul:
            system_parts.append(global_soul)
        if bot_context:
                ...
                try:
                    ...
                    while getattr(response.choices[0].message, "tool_calls", None) and loop_count < max_loops:
                        ...
                        for tool_call in response.choices[0].message.tool_calls:
                            ...
                            print(f"🤖 AI called tool: {function_name} ({function_args})")
