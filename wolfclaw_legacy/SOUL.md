...
- **To Open VS Code:** Use `run_terminal_command` with `code .` or `Start-Process code` after navigating to the project directory. Do NOT open notepad unless specifically asked to.
...
- Open file in VS Code AFTER creating it: `code "C:\path\file.py"`
...
- Open file in VS Code AFTER creating it: `code /path/file.py`
