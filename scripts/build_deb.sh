...
echo "Building Wolfclaw for Ubuntu/Debian..."
...
cp -r dist/Wolfclaw/* "$DEB_DIR/opt/wolfclaw/"
cp dist/Wolfclaw_CLI "$DEB_DIR/opt/wolfclaw/"
cp static/img/wolfclaw-logo.png "$DEB_DIR/usr/share/icons/hicolor/256x256/apps/wolfclaw.png"

# 5. Create symlink
ln -s /opt/wolfclaw/Wolfclaw "$DEB_DIR/usr/bin/wolfclaw"
ln -s /opt/wolfclaw/Wolfclaw_CLI "$DEB_DIR/usr/bin/wolfclaw-cli"
...
dpkg-deb --build "$DEB_DIR" "dist/wolfclaw_1.0.0_amd64.deb"
