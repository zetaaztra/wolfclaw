...
def build_windows_exe():
    ...
    print("Building Wolfclaw for Windows...")
    ...
    try:
        ...
        print("="*50)
        print(f"Executable folder: {project_root / 'dist' / 'Wolfclaw'}")
        print(f"GUI: dist\\Wolfclaw\\Wolfclaw.exe")
        print(f"CLI: dist\\Wolfclaw_CLI.exe")
    ...
    if os.path.exists(iscc) and iss_script.exists():
        ...
        try:
            ...
            print("="*50)
            print(f"Setup file: {project_root / 'dist' / 'Wolfclaw_Setup_v1.0.exe'}")
